   ...
   <section className='pt-[124px] pb-[140px] border-2 border-red-500'>
    <Container>
      ...
      <div className="mt-[65px]">
        <Flex className="gap-x-[15px] mb-[23px]">
          <input type="checkbox"/> 
          <Paragraph text="I have read and agree to the Privacy Policy"/>
        </Flex>
        <Flex className="gap-x-[33px] mb-[27px]">
          <Paragraph className="text-[14px]" text="Subscribe Newsletter"/>
          <div className="flex gap-x-[15px]">
            <input type="radio" name="selected"/>
            <Paragraph className="text-[14px]" text="Yes"/>
          </div>
          <div className="flex gap-x-[15px]">
            <input type="radio" name="selected"/>
            <Paragraph className="text-[14px]" text="No"/>
          </div>
       </Flex>
       <Button className="w-[200px] py-[16px]" text="Log in"/>
      </div>
    </Container>
   </section>
  )
