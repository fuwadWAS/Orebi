...
const BestSeller = ({cap, table, headphone, sunglass, capOffer, tableOffer, headphoneOffer, sunglassOffer}) => {
  return (
   <section className="pt-[118px] bg-[#FFFFF]">
    <Container>
        <Heading className="font-DM font-bold text-[#262626] text-[40px] pb-[48px]" text="Special Offers" as="h1"/>
        <Flex className="justify-between">
            <div className="w-[370px] h-[465px] bg-[#FFFFF] relative group">
                <Image className="w-[370px] h-[370px] shadow-[0_6px_10px_-1px_rgba(0,0,0,0.3)] mb-[16px]" src={cap}/>
            ...
            <div className="w-[370px] h-[465px] bg-[#FFFFF] relative group">
                <Image className="w-[370px] h-[370px] shadow-[0_6px_10px_-1px_rgba(0,0,0,0.3)] mb-[16px]" src={table}/>
            ...
            <div className="w-[370px] h-[465px] bg-[#FFFFF] relative group">
                <Image className="w-[370px] h-[370px] shadow-[0_6px_10px_-1px_rgba(0,0,0,0.3)] mb-[16px]" src={headphone}/>
            ...
            <div className="w-[370px] h-[465px] bg-[#FFFFF] relative group">
                <Image className="w-[370px] h-[370px] shadow-[0_6px_10px_-1px_rgba(0,0,0,0.3)] mb-[16px]" src={sunglass}/>
                <Badge className="w-[92px] py-[8px] px-[30px] absolute top-[20px] left-[20px]" text={sunglassOffer}/>
                <Flex className="justify-between">
                    <Heading className="font-DM font-bold text-[#262626] text-[20px] pb-[15px]" text="Basic Crew Neck Tee" as="h4"/>
                    <Price text="$44.00" />
                </Flex>
